    ...
    <div class="container wide-contain downloads">
      ...
      <div class="row g-3">
        <div class="col-xl-6">
          <div class="box">
            <div class="d-flex flex-column" style="min-height: 256px;">
              ...
              <p class="font-size-100 font-monospace"><strong>FILE TYPE:</strong> PDF and Pages</p>
        ...
        <div class="col-xl-6">
          <div class="box">
            <div class="d-flex flex-column" style="min-height: 256px;">
              ...
              <div class="mt-auto"><h2 class="h4 mb-2">Gridsome Neumorphic Starter</h2></div>
              <p class="font-size-300">
        ...
        <div class="col-xl-6">
          <div class="box">
            <div class="d-flex flex-column" style="min-height: 256px;">
              <p class="blog-details">2020-06-21</p>
              <div class="mt-auto"><h2 class="h4 mb-2">Sketch Resume Template</h2></div>
              <p class="font-size-300">
        ...
        <div class="col-xl-6">
          <div class="box">
            <div class="d-flex flex-column" style="min-height: 256px;">
              <p class="blog-details">2020-02-10</p>
              <div class="mt-auto"><h2 class="h4 mb-2">Enneagram Triads & Stances</h2></div>
              <p class="font-size-300">
        ...
        <div class="col-xl-6">
          <div class="box">
            <div class="d-flex flex-column" style="min-height: 256px;">
              <p class="blog-details">2019-09-15</p>
              <div class="mt-auto"><h2 class="h4 mb-2">10 Years of Photos Book</h2></div>
              <p class="font-size-300">
