  ...
  <StuffIUse>
    <article class="lead">
      <div class="row g-2">
        ...
        <div class="col-xl">
          <a class="btn btn-primary btn-lg w-100 mb-3 disabled" href="/stuff-i-use/on-my-desk">
            On My Desk &nbsp;💻
          </a>
        </div>
        <div class="col-xl">
      ...
      <h2 class="h1">On My Desk</h2>
      <p>
        I think we all learned during the pandemic that a proper workspace is a really important thing. I'm fortunate to have a home office, which is a true luxury, and work very hard to keep it well kept and ready to do work at all times. My desk is rarely cluttered. These items help me keep focused and to get my work done.
      </p>
