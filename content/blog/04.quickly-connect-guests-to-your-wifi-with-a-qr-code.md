...
date: "2019-08-16"
head.image: '/blog/blog-wifi-qr-code1.jpg'
alt: Photo of a picture frame with a QR code in it
tags: ["Article"]
description: I love it when you find a small way to use technology to make something mundane a bit easier. Inputting a wifi password is a tiny annoyance that we’ve all had to deal now for quite a while. It's likely you've mistyped many...
draft: false
layout: blog-post
---
# Connect Guests to Your Wifi with a QR Code

[August 16, 2019]{.blog-details}
