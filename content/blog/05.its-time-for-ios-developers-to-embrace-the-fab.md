---
category: Blog
title: "It's Time for iOS to Embrace the FAB"
date: "2020-02-26"
head.image: '/blog/blog-fab1.png'
alt: Photo of iPhone screens showing a floating action button in use
tags: ["Article"]
description: "I’ve always found Apple’s iOS User Interface ethos a bit odd. When you read Apple’s iOS Human Interface Guidelines, it feels sparse. The HIG is supposed to be the complete documentation for designers and developers..."
draft: false
layout: blog-post
---
# It's Time for iOS to Embrace the FAB

[February 26, 2020]{.blog-details}
